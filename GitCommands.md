...
Then, in the Terminal/Command Line Shell, type `git clone` and paste in the the URL after that. So it looks like this for our digitProjectDesign-Hub:
````
git clone https://github.com/newtfire/digitProjectDesign-Hub.git
````
